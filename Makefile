...
_api.clean.protocol:
	rm -f build/api/protocoltypes.pb.js build/api/protocoltypes.pb.d.ts build/weshnet.types.gen.ts
...
build/weshnet.types.gen.ts: api/protocoltypes.proto gen-clients.js
	node gen-clients.js > $@
